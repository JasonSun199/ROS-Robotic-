...
if("TRUE" STREQUAL "TRUE")
  set(sticky_fingers_SOURCE_PREFIX /home/jasonsun/ros_ws/src/learning_ros_external_pkgs_kinetic/sticky_fingers)
  set(sticky_fingers_DEVEL_PREFIX /home/jasonsun/ros_ws/devel)
  ...
  set(sticky_fingers_INSTALL_PREFIX /home/jasonsun/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'sticky_fingers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'sticky_fingers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jasonsun/ros_ws/src/learning_ros_external_pkgs_kinetic/sticky_fingers/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${sticky_fingers_dep}_FOUND)
      find_package(${sticky_fingers_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${sticky_fingers_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
